...
public class Maps {
     ...
     * @return
     */
    public static HashMap<String, Command> getPathMap(Drivetrain drivetrain, Collector collector, LEDs leds, LimelightFront frontLimelight, int cycle) {
        ...
        eventMap.put("Collect", new InstantCommand(() -> collector.setPower(1d), collector)); // Starts the collector intake
